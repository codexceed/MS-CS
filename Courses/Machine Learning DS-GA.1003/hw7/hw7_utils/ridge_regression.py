...
class RidgeRegression(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, l2_reg=1, step_size=.005,  max_num_epochs = 5000):
        ...
        square_loss = nodes.SquaredL2DistanceNode(a=self.prediction, b=self.y,
                                                     node_name="square loss")
        regularization = nodes.L2NormPenaltyNode(l2_reg, self.w, "regulaization")
        self.objective = nodes.SumNode(square_loss, regularization, "objective")
